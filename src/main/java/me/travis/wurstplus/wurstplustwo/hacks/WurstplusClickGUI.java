...
public class WurstplusClickGUI extends WurstplusHack {
	...
	WurstplusSetting border_frame_b = create("Border B", "ClickGUIBorderFrameB", 0, 0, 255);
	...
	WurstplusSetting background_widget_g = create("Background G", "ClickGUIBackgroundWidgetG", 0, 0, 255);
	WurstplusSetting background_widget_b = create("Background B", "ClickGUIBackgroundWidgetB", 0, 0, 255);
	WurstplusSetting background_widget_a = create("Background A", "ClickGUIBackgroundWidgetA", 150, 0, 255);
