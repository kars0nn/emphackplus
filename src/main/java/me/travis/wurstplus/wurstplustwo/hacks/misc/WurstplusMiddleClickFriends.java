	...
	public void update() {
        ...
        if (!clicked) {
            ...
            if (WurstplusFriendUtil.isFriend(player.getName())) {
                ...
                WurstplusMessageUtil.send_client_message("" + red + bold + player.getName() + reset + " is no longer your friend :(");
                            
            } else {
                WurstplusFriendUtil.Friend f = WurstplusFriendUtil.get_friend_object(player.getName());
                WurstplusFriendUtil.friends.add(f);
                WurstplusMessageUtil.send_client_message("" + green + bold + player.getName() + reset + " is now your friend :D");
            }
