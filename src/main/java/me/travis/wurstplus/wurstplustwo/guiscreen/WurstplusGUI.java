...
public class WurstplusGUI extends GuiScreen {
	...
	public int theme_frame_name_g = 255;
	public int theme_frame_name_b = 255;
	...
	public int theme_frame_background_a = 255;

	public int theme_frame_border_r = 0;
	public int theme_frame_border_g = 255;
	public int theme_frame_border_b = 255;
	...
	public int theme_widget_background_r = 255;
	public int theme_widget_background_g = 255;
	public int theme_widget_background_b = 255;
	public int theme_widget_background_a = 101;

	public int theme_widget_border_r = 255;
	public int theme_widget_border_g = 255;
	public int theme_widget_border_b = 255;
