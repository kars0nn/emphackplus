...
public class WurstplusMessageUtil {
	...
	public static ChatFormatting y = ChatFormatting.DARK_RED;
	public static ChatFormatting r = ChatFormatting.RESET;

	public static String opener = y + Wurstplus.WURSTPLUS_NAME + ChatFormatting.GRAY + " > " + r;
	...
	public static void toggle_message(WurstplusHack module) {
		if (module.is_active()) {
			...
			if (module.get_tag().equals("AutoCrystal")) {
				client_message_simple(opener + "we aint" + ChatFormatting.RED + " gaming " + r + "no mo'");
			} else {
