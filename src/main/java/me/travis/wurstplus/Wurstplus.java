...
@Mod(modid = "emphack", version = Wurstplus.WURSTPLUS_VERSION)
public class Wurstplus {

	@Mod.Instance
	private static Wurstplus MASTER;

	public static final String WURSTPLUS_NAME = "EmpHack+";
	public static final String WURSTPLUS_VERSION = "3.0";
	...
	public static ChatFormatting p = ChatFormatting.RED;
	...
	public void init_log(String name) {
		...
		send_minecraft_log("starting emphackplus");
	}
